...
Answer:  The Interval `r maxavg$interval` contains the maximum number of steps with on average `r maxavg$V1` steps.
...
```
There are `r nrow(miss)` missing records.
...
avg <- tapply(full$steps, full$interval, mean, na.rm=TRUE, simplify=T)
